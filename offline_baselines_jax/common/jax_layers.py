...
class SoftModule(nn.Module):
    ...
    state_base_arch: List[int] = field(default_factory=lambda : [256, 256])
    task_base_arch: List[int] = field(default_factory=lambda : [256])
    net_arch: List[int] = field(default_factory=lambda : [4, 4, 4])
    module_arch: List[int] = field(default_factory=lambda : [256])
